...
def isSafe(lineList):
    ...
    listLength = len(lineList)
    if listLength == 4:
        if ((lineList[0] > lineList[1] and lineList[1] > lineList[2] and lineList[2] > lineList[3]) or
            (lineList[0] < lineList[1] and lineList[1] < lineList[2] and lineList[2] < lineList[3])):
            ...
            if(((abs(lineList[0] - lineList[1]) >= 1 and abs(lineList[0] - lineList[1]) <= 3) and 
                ...
                (abs(lineList[2] - lineList[3]) >= 1 and abs(lineList[2] - lineList[3]) <= 3))):
                    safetyCount += 1
